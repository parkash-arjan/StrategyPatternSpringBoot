...
@Component
@APIActionEntity(name = "APIActionA", accountType = ActionAssociation.SERVICE_ACCOUNT, apiType = APIType.TRANSACTION)
public class ServiceAccountTransactionAPIActionA implements APIAction {
  ...
  public APIActionName getActionName() {
    return APIActionName.SERVICE_ACCOUNT_TRANSACTION_API_ACTION_A;
  }
